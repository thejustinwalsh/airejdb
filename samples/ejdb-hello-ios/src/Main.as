	...
	public class Main extends Sprite
	{
		...
		public function start(extensionID:String, success:Boolean):void
		{
			...
			try {
				...
				if (File.applicationStorageDirectory.resolvePath("hello").hasOwnProperty('preventBackup')) {
					File.applicationStorageDirectory.resolvePath("hello")['preventBackup'] = true;
				}
				//db.close();
			}
			catch(e:Error) {
